...
# Define number of output classes (set this appropriately)
classes = 6  # Replace with the correct number if not already defined
...
classes = 6  # change this if needed
...
# Number of output classes
classes = 6  # adjust if needed

# Define the regularized model
model_r = Sequential([
    Dense(120, activation='relu', kernel_regularizer=regularizers.l2(0.1), name="L1"),
    Dense(40, activation='relu', kernel_regularizer=regularizers.l2(0.1), name="L2"),
    Dense(classes, activation='linear', name="L3")
], name="Regularized")
